...
export const createClientsForm = () => {
  ...
  inputName.addEventListener('keyup', (e) => {
    inputName.value = e.target.value.charAt(0).toUpperCase() + e.target.value.slice(1).toLowerCase()
  });
  inputSurname.addEventListener('keyup', (e) => {
    inputSurname.value = e.target.value.charAt(0).toUpperCase() + e.target.value.slice(1).toLowerCase()
  });
  inputLastName.addEventListener('keyup', (e) => {
    inputLastName.value = e.target.value.charAt(0).toUpperCase() + e.target.value.slice(1).toLowerCase()
  });
